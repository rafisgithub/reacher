...
# Generate 500 test emails using highly probable corporate role addresses.
# We avoid randomly generating names because those generally bounce. 
# Generic role addresses like 'info@', 'support@', and 'privacy@' 
# exist on most major corporate domains and provide valid "safe" responses.
prefixes = [
    "info", "support", "sales", "contact", "hello", "privacy", "security",
    "jobs", "careers", "press", "media", "help", "admin", "webmaster", 
    "legal", "billing", "marketing", "dev", "hr", "office"
]

domains = [
    "google.com", "microsoft.com", "apple.com", "amazon.com", "meta.com",
    "netflix.com", "tesla.com", "github.com", "spotify.com", "ibm.com",
    "oracle.com", "intel.com", "cisco.com", "hp.com", "dell.com",
    "salesforce.com", "adobe.com", "sap.com", "vmware.com", "nvidia.com",
    "amd.com", "stripe.com", "paypal.com", "airbnb.com", "uber.com"
]
...
for prefix in prefixes:
    for domain in domains:
        emails_to_test.append(f"{prefix}@{domain}")
